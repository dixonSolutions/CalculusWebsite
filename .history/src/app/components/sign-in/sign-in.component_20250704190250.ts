  ...
  async onOtpSubmit(): Promise<void> {
    ...
    try {
      ...
      if (authResult.success) {
        console.log('Phone authentication successful, triggering auth state check...');
        
        // Trigger phone auth state change detection
        this.supabase.triggerPhoneAuthCheck();
        
        // Give a moment for the session to be fully set and then navigate
        setTimeout(() => {
