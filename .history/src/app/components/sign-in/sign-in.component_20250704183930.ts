...
export class SignInComponent {
  ...
  async onOtpSubmit(): Promise<void> {
    ...
    try {
      ...
      // Create a user session manually since we're using custom SMS
      // In a real app, you'd integrate this with your backend auth system
      console.log('Phone verification successful for:', phone);
      
      // For now, redirect or handle successful authentication
      // You might want to create a user session here
      alert('Phone verification successful! You are now logged in.');
